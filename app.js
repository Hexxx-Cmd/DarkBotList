...
client.channels.get('682661562678247584').send(`✔️ | \`${req.user.username}#${req.user.discriminator}\` FORENSIC USER \`${db.fetch(`botlar.${req.params.botID}.isim`)}\` REPORTED NAMED BOT \n**REASON:** \`${ayar['mesaj-1']}\``)
}
if(ayar['mesaj-2']) {
